    ...
    public partial class DomainTablesAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Agent ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false, comment: "Agent Phone Number"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Agent Username")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "House ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "House Category"),
                    AgentId = table.Column<int>(type: "int", nullable: false, comment: "House agent"),
